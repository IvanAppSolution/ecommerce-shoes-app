  ...
  return (
    <ScreenComponent style={styles.container}>
      ...
      <View style={styles.checkoutContainer}>
        <Row title={'Shipping fee'} price={'$20'} />
        <View style={styles.separator} />
        <Row title={'Subtotal'} price={'$330.00'} />
        <View style={styles.separator} />
        <Row title={'Total'} price={'$350.00'} />
...
const Row = ({ title, price }: { title: string; price: string }) => {
  return (
...
const AddressCard = ({ title, selected, setSelected, address, phone }: AddressCardProps) => {
  const isSelected = selected == title;
  return (
    <TouchableOpacity
